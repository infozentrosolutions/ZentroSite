...
const StudentDashboard = () => {
    ...
    return (
        <div className="max-w-7xl mx-auto space-y-6 animate-fade-in pb-10">
            <Helmet>
                <title>Student Dashboard | Zentro Solutions Learning Portal</title>
                <meta name="description" content="Manage your internship progress, view daily tasks, join live classes, and download certificates on your Zentro Solutions dashboard." />
                <meta name="keywords" content="student dashboard, internship management, zentro solutions portal, learning progress" />
                <link rel="canonical" href="https://zentrosolution.fun/student-dashboard" />

                {/* Open Graph / Social Media */}
                <meta property="og:title" content="Student Dashboard | Zentro Solutions" />
                <meta property="og:description" content="Manage your internship progress and access learning materials." />
                <meta property="og:url" content="https://zentrosolution.fun/student-dashboard" />
