...
const Projects = () => {
    ...
    return (
        <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
            <Helmet>
                <title>Student Projects Showcase | Zentro Solutions Portfolio</title>
                <meta name="description" content="Explore real-world projects built by Zentro Solutions students and interns. Showcasing excellence in MERN, Java, and Python development." />
                <meta name="keywords" content="student project portfolio, cse final year projects, web development showcase, zentro solutions student work" />
                <link rel="canonical" href="https://zentrosolution.fun/projects" />

                {/* Open Graph / Social Media */}
                <meta property="og:title" content="Student Projects | Zentro Solutions Showcase" />
                <meta property="og:description" content="Discover the industry-standard projects built by our interns and students." />
                <meta property="og:url" content="https://zentrosolution.fun/projects" />
                <meta property="og:type" content="website" />
            </Helmet>
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Innovation Showcase by Zentro Solutions</h1>
