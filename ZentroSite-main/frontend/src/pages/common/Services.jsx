...
const Services = () => {
    ...
    return (
        <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
            <Helmet>
                <title>Our Services | Zentro Solutions - Web & Software Development</title>
                <meta name="description" content="Software development, web applications, and professional internship training services by Zentro Solutions. Excellence in technology solutions." />
                <meta name="keywords" content="software development services, web development company, tech training services, zentro solutions offerings" />
                <link rel="canonical" href="https://zentrosolution.fun/services" />

                {/* Open Graph / Social Media */}
                <meta property="og:title" content="Services by Zentro Solutions" />
                <meta property="og:description" content="From enterprise software to custom web apps and student training, explore our technology services." />
            ...
            <div className="max-w-7xl mx-auto">
                <ScrollReveal className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Professional Services by Zentro Solutions</h1>
