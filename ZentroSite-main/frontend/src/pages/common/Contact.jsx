...
const Contact = () => {
    ...
    return (
        <div className="min-h-screen pt-24 pb-20 px-4 sm:px-6 lg:px-8">
            <Helmet>
                <title>Contact Zentro Solutions | Get in Touch for Internships & Services</title>
                <meta name="description" content="Have questions about our internship programs or web development services? Contact Zentro Solutions today. We're here to help." />
                <meta name="keywords" content="contact zentro solutions, internship inquiry, web development contact, tech training support" />
                <link rel="canonical" href="https://zentrosolution.fun/contact" />

                {/* Open Graph / Social Media */}
                <meta property="og:title" content="Contact Zentro Solutions" />
                <meta property="og:description" content="Reach out to us for enquiries about internships, training, or development services." />
            ...
            <div className="max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">Connect with Zentro Solutions</h1>
