...
const NotFound = () => {
    return (
        <div className="min-h-screen bg-[#FDFBF7] flex items-center justify-center p-4 sm:p-6 lg:px-8 lg:py-16 relative overflow-hidden">
            <Helmet>
                <title>404 - Page Not Found | Zentro Solutions</title>
                <meta name="description" content="The page you're looking for doesn't exist. Head back to Zentro Solutions' homepage to explore our programs and services." />
            </Helmet>
