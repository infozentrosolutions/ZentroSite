...
const Quiz = ({ isEmbedded = false, onViewPrograms }) => {
    ...
    return (
        <div className={`${isEmbedded ? 'py-4' : 'min-h-screen py-12'} flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 relative`}>
            {!isEmbedded && (
                <Helmet>
                    <title>Internship Finder Quiz | Zentro Solutions Career Path</title>
                    <meta name="description" content="Not sure which internship to choose? Take our Zentro Solutions Internship Finder Quiz to discover the best tech career path for you." />
                    <meta name="keywords" content="internship quiz, career path finder, tech internship test, zentro solutions quiz" />
                    <link rel="canonical" href="https://zentrosolution.fun/quiz" />

                    {/* Open Graph / Social Media */}
                    <meta property="og:title" content="Internship Finder Quiz | Zentro Solutions" />
                    <meta property="og:description" content="Find the perfect tech internship path for you with our quick finder quiz." />
            ...
            <div className={`max-w-xl w-full ${isEmbedded ? '' : 'mt-10'}`}>
                <div className="text-center mb-10">
                    <h2 className="text-3xl font-extrabold text-gray-900 transition-all duration-300">Zentro Solutions Career Path Finder</h2>
