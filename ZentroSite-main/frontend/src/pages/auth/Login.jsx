...
const Login = () => {
    ...
    return (
        <div style={{ zoom: "80%" }} className="min-h-[125vh] bg-[#FDFBF7] flex items-center justify-center p-4 pt-32 pb-12 sm:p-6 lg:p-8 relative overflow-hidden">
            <Helmet>
                <title>{isStudentMode ? 'Student Login | Zentro Solutions Portal' : 'Admin Login | Zentro Solutions Management'}</title>
                <meta name="description" content={isStudentMode ? 'Access your Zentro Solutions student portal to manage your internships and projects.' : 'Secure administrative access for Zentro Solutions staff and teachers.'} />
                <meta name="keywords" content="zentro solutions login, student portal, admin dashboard access, internship management login" />
                <link rel="canonical" href="https://zentrosolution.fun/login" />

                {/* Open Graph / Social Media */}
                <meta property="og:title" content="Login | Zentro Solutions" />
                <meta property="og:description" content="Access your Zentro Solutions account for internship management and learning." />
